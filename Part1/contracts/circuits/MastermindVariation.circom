...
//This is Mini Mastermind version with 6 digits 4 holes, and 6 guesses
...
template MastermindVariation() {
    ...
    // Create a constraint that the pubNumGuess are less than 7.
    component lessThan7 = LessThan(4);
    lessThan7.in[0] <== pubNumGuess;
    lessThan7.in[1] <== 7;
    lessThan7.out === 1;
...
component main {public [pubGuessA, pubGuessB, pubGuessC, pubGuessD, pubNumHit, pubNumBlow, pubNumGuess, pubSolnHash]}= MastermindVariation();